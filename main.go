...
var (
	...
	flagHackParseNotationICCF = flag.String("parseNotationICCF", "", "ParseNotation API call. Requires a JSON string with arguments. Please review spec.")
)
...
func main() {
	...
	case *flagHackParseNotationICCF != "":
		handleCliHackParseNotationICCF(flagHackParseNotationICCF)
	}
}
